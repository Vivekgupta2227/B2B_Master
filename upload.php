...
<html lang="en">
 <head>
  ...
  <title>Jetleads- Import Csv file</title>
 ...
 <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Lead Catcher</a>
            <a class="collapse-item" href="cards.html">Sending Calender</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="login.html">Teammates</a>
            <a class="collapse-item" href="register.html">Billing</a>
            <a class="collapse-item" href="forgot-password.html">Redeem</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Vivek Gupta</span>
                <img class="img-profile rounded-circle" src="img/Starry 3.jpg">
              </a>
   ...
   <br />
   <h3 align="center">Leads of the Day</h3>
   <br />
