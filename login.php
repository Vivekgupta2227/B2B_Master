                ...
                <div class="p-5">
                  ...
                  <form class="user" method="post">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="user_email" id="user_email" aria-describedby="user_email" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
